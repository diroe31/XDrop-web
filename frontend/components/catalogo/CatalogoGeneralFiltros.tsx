...
export default function CatalogoGeneralFiltros({
  ...
  const coleccionFiltrada = filtro ? colecciones.find((c) => c.id === filtro) : null;
  ...
  return (
    <div>
      ...
      {coleccionFiltrada ? (
        // ===== VISTA DE UNA SOLA COLECCION: todos los productos, sin limite =====
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          {(() => {
            const productos = productosPorColeccion[coleccionFiltrada.id] || [];
            return (
              <>
        ...
        // ===== VISTA "TODAS": agrupado por coleccion, 3 + ver mas =====
